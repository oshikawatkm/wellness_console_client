...
class Resevations extends Component {
  render() {
    ...
    if (user === null || loading || user["Reservations"] === undefined) {
      ...
      reservationContent = <Table columns={columns} key={user["Reservations"].id}  dataSource={user["Reservations"]} />
    }
...
export default connect(mapStateToProps, { getMe })(Resevations);